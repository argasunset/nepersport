...
$stmt = $conn->prepare("SELECT nama_user, password_user, email, no_telepon_user, alamat_user, role_user, status FROM user WHERE role_user != 'admin'");
$stmt->execute();
$result = $stmt->get_result();
    ...
    <div class="main-panel">
          ...
          <div class="table-responsive">
            <table id="userTable" class="table table-striped table-bordered">
              ...
              <tbody>
                ...
                $stmt = $conn->prepare("SELECT id_user, nama_user, email, no_telepon_user, alamat_user, role_user, status FROM user WHERE role_user != 'admin'");
                $stmt->execute();
                $result = $stmt->get_result();
                ...
                ?>
                  <tr>
                    ...
                    <td><?= htmlspecialchars($row['no_telepon_user']); ?></td>
                    <td><?= htmlspecialchars($row['alamat_user']); ?></td>
                    <td><?= htmlspecialchars($row['role_user']); ?></td>
                    <td class="text-center">
                      <button class="status-btn btn btn-sm <?= $row['status'] == 'Member' ? 'btn-success' : 'btn-danger'; ?>"
                        data-id="<?= $row['id_user']; ?>"
      ...
      <script>
        $(document).ready(function() {
          ...
          $("#searchNavbar, #searchDropdown").on("keyup", function() {
          ...
          function attachStatusButtonEvent() {
            $(".status-btn").off("click").on("click", function() {
              var button = $(this);
              var userId = button.data("id");
              var currentStatus = button.data("status");
              var newStatus = (currentStatus === "Member") ? "Non Member" : "Member";
